...
Here two linear elastic material nodes are created for the plate and the wedges. Isotropic solid models are used, and Young's modulus and Poisson's ratios from material properties are used. Alternatively pressure--wave and shear--wave speeds can be used. Damping sub-nodes should be applied to both materials.
